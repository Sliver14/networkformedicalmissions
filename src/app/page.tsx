            ...
            {upcomingEvents.map((event) => (
              <div key={event.id} className="events-one__single group">
                <div className="events-one__img">
                  <Image src={(event.image ? event.image.split(',')[0].trim() : null) || "/assets/images/resources/events-one-img-1.jpg"} alt={event.title} width={400} height={300} className="w-full object-cover" />
              ...
              <div key={news.id} className="news-two__single group">
                <div className="news-two__img-box">
                  <div className="news-two__img relative">
                    <Image src={(news.image ? news.image.split(',')[0].trim() : null) || "/31.jpeg"} alt={news.title} width={400} height={250} className="w-full h-[250px] object-cover" />
